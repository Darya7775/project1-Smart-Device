...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // ---------------------------------
  // Footer
  var listSingleOne = document.querySelectorAll('.accordion');
  var lists = document.querySelectorAll('.footer__list');
  var listButtonOne = document.querySelectorAll('.footer__button');
  var listTextOne = document.querySelectorAll('.text-accordion');
  var breakpointСhangeFooter = function breakpointСhangeFooter() {
  ...
  // Main-unit
  var buttonMainUnit = document.querySelector('.main-unit__button');
  ...
  breakpointChecker();
  buttonMainUnit.addEventListener('click', function (e) {
    e.preventDefault();
    var id = buttonMainUnit.getAttribute('href');
  ...
  var aboutCompanyWrapperAccordion = document.querySelector('.about-company__accordion');
  var aboutCompanyButton = document.querySelector('.about-company__button');
  var aboutCompanyWrapperAccordionMobile = document.querySelector('.about-company__wrapper');
  ...
  var serviceTitle = document.querySelector('.service__title');
  var changeServiceTitle = function changeServiceTitle() {
    if (breakpoint.matches) {
  ...
  var formCheckbox = document.querySelector('#checkbox');
  var formLabelCheckbox = document.querySelector('#label-checkbox');
  ...
  var formCheckboxModal = document.querySelector('#modal-checkbox');
  var formLabelCheckboxModal = document.querySelector('#modal-label-checkbox');
